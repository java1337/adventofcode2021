...
class Day20211202(private val movementsRaw: List<String>): DailyChallenge {
    ...
    companion object {
        fun create(): Day20211202 {
            val input = Utils.readFileAsListOfString("Day20211202.txt")
            return Day20211202(input)
        }

        fun parseMovements(movementsIn: List<String>): List<Movement> {
            println("reading movements")
            return movementsIn.map {
                val parts = it.split(" ")
    ...
    override fun getLabel() = "2021/12/02 - Dive!"
}